...
Este trabajo analiza cómo se define, calcula y modifica el concepto de entropía al pasar de un gas ideal a un gas real de Van der Waals. Se parte de la definición termodinámica de Clausius ($dS = \delta Q_\text{rev}/T$) y se deriva la entropía del gas ideal, cuya expresión conduce a la paradoja de Gibbs. La resolución exige la mecánica estadística de Boltzmann ($S = k_B\ln\Omega$) con la hipótesis de indistinguibilidad cuántica de las partículas, dando lugar a la fórmula de Sackur–Tetrode. Se compara con la entropía del gas de Van der Waals, que incorpora el volumen excluido y las interacciones atractivas. Finalmente, se muestra que la entropía de Boltzmann fue la herramienta con que Planck derivó la cuantización de la energía en 1900, conectando el Módulo 1 con el Módulo 2 del diplomado.

**Palabras clave:** entropía, segunda ley, gas ideal, Van der Waals, paradoja de Gibbs, Sackur–Tetrode, distribución de Planck, catástrofe ultravioleta.

---

## Introducción

La entropía es el concepto termodinámico con mayor poder unificador. Clausius la creó en 1865 para formalizar la irreversibilidad de los procesos naturales. Boltzmann le dio un significado microscópico en 1877. Gibbs reveló una inconsistencia fundamental en su aplicación al gas ideal —la paradoja que lleva su nombre. Sackur y Tetrode la resolvieron en 1911–12, introduciendo de manera necesaria la constante de Planck $h$. Y Planck, en 1900, la usó como herramienta para postular la cuantización de la energía y fundar la física cuántica.

Este informe persigue tres objetivos:
1. Derivar la entropía termodinámica del gas ideal y del gas de Van der Waals desde primeros principios.
2. Demostrar la paradoja de Gibbs y su resolución mediante la mecánica estadística de Boltzmann.
3. Mostrar cómo esa mecánica estadística condujo a Planck a la física cuántica, conectando el Módulo 1 con el Módulo 2 del diplomado.

**Metodología:** revisión analítica de fuentes primarias y derivación matemática de todos los resultados con pasos intermedios completos.

**Clase elegida:** Clase 5 (segunda ley, entropía de Boltzmann), complementada con contenido de la Clase 4 (gas de Van der Waals). Ambas clases comparten el hilo conductor de la entropía como variable de estado sensible a la estructura molecular del sistema.
...
> **Ejercicio:** Un mol de argón (gas monoatómico ideal) a $T_i = 300\,\text{K}$ y $V_i = 24.6\,\text{L}$ se expande adiabáticamente de manera reversible hasta $V_f = 49.2\,\text{L}$. (a) Calcule la temperatura final $T_f$. (b) Verifique que $\Delta S = 0$. (c) Calcule el trabajo realizado por el gas. *Respuesta: $T_f = 300/2^{2/3} \approx 189\,\text{K}$; $W = \frac{3}{2}R(T_i - T_f) \approx 1380\,\text{J}$.*
...
**Ley de desplazamiento de Wien:** Imponiendo $\partial u/\partial f = 0$ (en términos de $\lambda$) se obtiene la ecuación trascendente $5(1 - e^{-hc/\lambda k_BT}) = hc/\lambda k_BT$, cuya solución numérica da $$\lambda_\text{max} = \frac{hc}{4.965\, k_B} \cdot \frac{1}{T} = \frac{b}{T}, \qquad b = 2.898 \times 10^{-3}\,\mathrm{m{\cdot}K}$$
...
**Líneas abiertas para trabajos futuros:**
- ¿Cómo generalizar la fórmula de Sackur–Tetrode a gases cuánticos (Bose-Einstein, Fermi-Dirac) a bajas temperaturas, donde la longitud de onda de De Broglie es comparable al espaciado interparticular?
- ¿Cómo se comporta la entropía en la región crítica del gas de Van der Waals, donde la compresibilidad isotérmica diverge y las fluctuaciones se vuelven macroscópicas?
- ¿Qué conexión existe entre la entropía de Boltzmann y la entropía de Shannon en teoría de la información, y qué implica para la física del cómputo cuántico?

Estas preguntas son el punto de partida natural del Módulo 2 y de los módulos posteriores del diplomado.
